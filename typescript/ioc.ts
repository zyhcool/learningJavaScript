...
@ClassDec()
class TestService {
    constructor(public readonly otherService: OtherService, num: number) {}
    @PropertyDec()
    public name: string;
    @MethodDec()
...
//     console.log(
//         Reflect.getMetadata("design:paramtypes", target.prototype, "handle")
//     );
//     console.log(Reflect.getMetadata("design:type", target.prototype, "handle"));
//     console.log(
//         Reflect.getMetadata("design:returntype", target.prototype, "handle")
//     );
//     console.log("-------------------");
...
//     );
//     console.log(
//         Reflect.getMetadata("design:returntype", target.prototype, "name")
//     );
